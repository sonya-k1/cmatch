...
streamlit run cmatch/cmatch.py [template file] [output file path] [similarity threshold] [overlap_tolerance (bases)] [sequence files]

## Streamlit Example

$ cd simple_example/
$ streamlit run ../cmatch.py template.json test_results.parquet 0.9 0 vio-B0030-B0030-B0030-B0030-B0030.seq vio-B0030-B0031-B0032-B0033-B0064.seq


# Existing Test commands from original repository
## Run the tests
